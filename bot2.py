    ...
    while True:
        ...
        if debug and GUI_mode:
            ...
            for i in range(ROWS):
                for j in range(COLS):
                    ...
                    cell_rect = pygame.Rect(x, y, CELL_SIZE[0], CELL_SIZE[1])
                    if target_location is not None and (i, j) == target_location:
                        pygame.draw.rect(screen, (0, 0, 255), cell_rect, 3)
                    else:
                        pygame.draw.rect(screen, (255, 255, 255), cell_rect, 3)
            # Draw button
        ...
        if clicked or not GUI_mode:
            ...
            if leak_in_vincinty:
                ...
                visit_possible_leak_cells_in_vincity()

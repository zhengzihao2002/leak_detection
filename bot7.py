...
leak_location = [leak_location1,leak_location2] # BOT7 : two leaks
if debug:
    printShip(ship)
if debug:
...
total_leak = 2 # BOT7 : multiple leaks
num_actions = 0
try:
    ...
    while True:
        ...
        if debug and GUI_mode:
            ...
            for i in range(ROWS):
                for j in range(COLS):
                    ...
                    elif (i,j) in leak_location and (i,j) == bot_location: # BOT7 : multiple leaks
                    ...
                    elif (i, j) in leak_location: # BOT7 : multiple leaks
                        # leak
        ...
        if clicked or not GUI_mode:
            ...
            if debug and not GUI_mode:
                printShip(ship)
            if bot_location in leak_location: # BOT7 : multiple leaks
                # Leak Found: break the loop
                total_leak -=1 # BOT7 : multiple leaks
